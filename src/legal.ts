 ...
 *  Radio/text questions use a string value; checkbox questions use an array of answer codes.
 *  Only include questions that are visible in the default flow. */
function buildDefaultQuestionnaire(featureDescription: string): Array<{ questionCode: string; type: string; value: string | string[] }> {
  return [
    // === Legal Review ===
